...
export const Dashboard: React.FC<DashboardProps> = ({ user }) => {
  ...
  const handleStartShift = async () => {
    ...
    if (result) {
        ...
        setStartData({
            ...
            displayDate: now.toLocaleDateString(language === 'es' ? 'es-ES' : 'en-US', { timeZone: "America/New_York" })
        });
    }
    setIsActive(true);
  ...
  const timeDisplay = currentDate.toLocaleTimeString(locale, { timeZone: 'America/New_York', hour12: false, hour: '2-digit', minute: '2-digit', second: '2-digit' });
