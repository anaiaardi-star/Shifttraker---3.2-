...
export const Reports = () => {
    ...
    const handleExport = () => {
        ...
        link.setAttribute("download", `Report_ShiftTrack_${new Date().toISOString().split('T')[0]}.csv`);
        ...
        <div className="flex-1 w-full max-w-[1200px] mx-auto px-6 md:px-10 py-8 relative animate-in fade-in duration-500">
            ...
            <div className="flex flex-wrap items-end justify-between gap-6 mb-8">
                <div className="flex min-w-72 flex-col gap-2">
                    ...
                    <p className="text-slate-900 dark:text-white text-4xl font-black tracking-tight">{t('rep.title')}</p>
                    <p className="text-slate-500 dark:text-slate-400 text-base font-normal">{t('rep.desc')}</p>
                </div>
